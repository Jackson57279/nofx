...
// WithOpenRouterConfig sets OpenRouter configuration.
//
// Usage example:
//
//	client := mcp.NewClient(mcp.WithOpenRouterConfig("sk-or-xxx"))
func WithOpenRouterConfig(apiKey string) ClientOption {
	return func(c *Config) {
